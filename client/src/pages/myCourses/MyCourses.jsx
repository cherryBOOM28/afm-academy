...
function MyCourses() {
  ...
  return (
    <div className="my-courses-page text-content">
      <div
        className="interval"
                ...
                {isLoading ? (
                  ...
                  <div className="courses-list text-content">
                    {courses.map((course, index) => {
                      ...
                      return (
                        <div
                          className="course-card text-content"
                          key={index}
                          onClick={() => {
                        ...
                        >
                          ...
                          <div className="info text-content">
                            <div className="course-name text-content">
                              {course_name}
                            </div>
                            <div
                            ...
                            <div className="info-row text-content">
                              <div className="langAndDuration text-content">
                                {"РУС"} | {"1ч 45мин"}
                              </div>
