    ...
    return ( 
        <>
            <div className='calendar-page'>
                <div className='text-content' style={{ letterSpacing: getLetterSpacing(letterInterval) }}>
                <VisualModal 
                ...
                <main className='page-content container'>
                    ...
                    <h2 className='text-content'style={{ letterSpacing: getLetterSpacing(letterInterval) }}>{t('calendar of events')}</h2>
                    ...
                    <div className="calendar-wrapper">
                        ...
                        <div className="calendar-events" style={{ letterSpacing: getLetterSpacing(letterInterval) }}>
                            {
                                !showEvent ? 
                                    events.map((event) => {
