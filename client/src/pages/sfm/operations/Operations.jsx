    ...
    return (
        <div className={cl.OperationsWrapper}>
            ...
            <div className={cl.container}>
                ...
                <p className={cl.text}>Типологии, схемы и способы легализации (отмывания) преступных доходов и финансирования терроризма утверждаются уполномоченным органом и доводятся до субъектов финансового мониторинга путем размещения на своем интернет-ресурсе.</p>
