                ...
                <Reveal>
                    <TabsGlossary 
                        ...
                        tabsGlossary={{
                            ...
                            'Профессиональное': 'когда лицо либо преступная организация самостоятельно пытается скрыть незаконное происхождение доходов от незаконного оборота путем отмывания денег',
                        }}
                        color={'#3A3939'}
                        tabsBackgroundColor={'#BAD6FF'}
                    />
        ...
        case 13:
            return (<LessonPage name={'Отчет о Взаимной оценке'} lecturer={'AML Academy'}>
                ...
                <Reveal>
                    <Report_Warning>
                        <>
                        График взаимных оценок ЕАГ размещается на официальном интернет ресурсе ЕАГ <a href="https://eurasiangroup.org/ru/general-information">https://eurasiangroup.org/ru/general-information</a>
                        </>
                    </Report_Warning>
                </Reveal>
                <Sizebox height={80} />
