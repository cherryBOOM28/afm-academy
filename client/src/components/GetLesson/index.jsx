...
import image99 from '../../assets/images/image_99.jpg';
...
import image95 from '../../assets/images/image_95.jpg';
import image94 from '../../assets/images/image_94.jpg';
...
import image89 from '../../assets/images/image_89.jpg';
...
`}/>
          ...
          <Reveal>
            ...
            <Centered>
              <BoxOfThree
                ...
                answer="Закрыто нажмите чтобы открыть"
                width="43%"
                height="230px"
          ...
          <Reveal>
            <DropdownGlossaryList
              list={[
                {
                  title:
                    'Комитет по правовой статистике Генеральной прокуратуры РК',
                  description:
                ...
                {
                  title: 'Министерство иностранных дел РК',
                  description:
                ...
                {
                  title: 'Генеральная прокуратура РК (ГП РК)',
                  description:
                ...
                {
                  title:
                    'Совет безопасности организации объединенных наций (СОВБЕЗ ООН)',
                  description:
      ...
      return (
        ...
        >
          <Reveal>
            ...
            <RandomGlossary
              title={
                'АФМ РК является государственным органом, непосредственно подчиненным и подотчетным Президенту Республики Казахстан'
              }
              text={
                'осуществляющим руководство в сфере ПОД/ФТ, а также по предупреждению, выявлению, пресечению, раскрытию и расследованию экономических и финансовых правонарушений, отнесенных законодательством Республики Казахстан к ведению этого органа \n' +
          ...
          <Reveal>
            ...
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
              <>
                До подписания Указа функции подразделения финансовой разведки
                осуществлялись{' '}
                <span class="bold">Комитетом по финансовому мониторингу</span>,
                являвшимся подразделением Министерства финансов Республики
                Казахстан.
              </>{' '}
            </HeaderWithLine>
            <Sizebox height={40} />
          ...
          <Reveal>
            <TextWithTitle
              title={
                'В Республике Казахстан АФМ является государственным органом, наделенным всеми полномочиями и функциями ПФР, а также осуществляет функции по проведению расследований.'
              }
            />
            <Sizebox height={40} />
          </Reveal>
          <Reveal>
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
              <>
                ...
                <span class="bold">Службой экономических расследований</span>{' '}
                (СЭР АФМ), которая вместе со своими территориальными
                департаментами (Департамент экономических расследований - ДЭР)
                образует оперативно-следственное подразделение, осуществляющее
                деятельность по предупреждению, выявлению, пресечению, раскрытию
                и расследованию преступлений и правонарушений.
              </>
            </HeaderWithLine>
            <Sizebox height={40} />
          </Reveal>
          <Reveal>
            <TextWithTitle
              title={
                'СЭР АФМ, как и органы прокуратуры, внутренних дел и антикоррупционная служба, относится к правоохранительным органам. СЭР АФМ взаимодействует с АФМ в рамках компетенции на общих основаниях в соответствии с законодательством.'
              }
            />
            <Sizebox height={40} />
          </Reveal>
          <Reveal>
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
              <>
                В целом АФМ РК является <span class="bold">гибридным</span>{' '}
                органом, так как его структура включает как правоохранительный
                блок (служба экономических расследований), так и
                административный (подразделение финансовой разведки).{' '}
              </>
            </HeaderWithLine>
            <Sizebox height={40} />
          </Reveal>
          ...
          <Reveal>
            <TextWithTitle
              title={
                'АФМ являясь национальным подразделением финансовой разведки, осуществляет следующие функции в целях ПОД/ФТ:'
              }
            />
          ...
          <Reveal>
            <ImageLine img={image72} color={'#FFFFFF'} />
            <Sizebox height={40} />
          </Reveal>
          <Reveal>
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
          ...
          <VideoLine
            url={
              'https://videos.sproutvideo.com/embed/7990d0b51d1ae4c1f0/6e43cdd74851d083?playerColor=1f71a1'
            }
          />
          ...
          <Reveal>
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
              <>
                Теперь, когда вы узнали о задачах и функциях АФМ, мы остановимся
                на наиболее важных функциях поподробнее
              </>
            </HeaderWithLine>
          </Reveal>
          <Reveal>
      ...
      return (
        <LessonPage name={'Функции АФМ'} lecturer={'AML Academy'}>
          ...
          <Reveal>
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
              <>
                АФМ отвечает за руководство и координацию деятельности в области
                противодействия ОД/ФТ и получает поддержку на высоком уровне
                страны. Одним из эффективных инструментов является созданная при
                Администрации Президента Республики Казахстан{' '}
                <span class="bold">
                  Межведомственная рабочая группа по вопросам подготовки ко
                  второму раунду взаимной оценки ЕАГ
                </span>{' '}
                (МВРГ).
              </>
            </HeaderWithLine>
    ...
    case 26:
      return (
        <LessonPage name={'Урок 1'} lecturer={'AML Academy'}>
          <Reveal>
            <ImageLine img={image75} color={'#FFFFFF'} />
            <Sizebox height={40} />
          </Reveal>
          <Reveal>
            <TextWithTitle
              title={
                'В КАКИХ ЦЕЛЯХ СФМ НЕОБХОДИМО ОБУЧАТЬСЯ, ПОВЫШАТЬ КВАЛИФИКАЦИЮ И ПРОХОДИТЬ ТЕСТИРОВАНИЕ?\n'
              }
            />
          ...
          <Reveal>
            <TextWithTitle
              title={
                'В целях реализации Требований по подготовке и обучению Субъект:'
              }
            />
          ...
          <Reveal>
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
              <>
                Субъекты проходят обучение в целях ПОД/ФТ в соответствии с{' '}
                <span class="bold">программой обучения</span>, которая содержит
                указанные ниже направления:
              </>
            </HeaderWithLine>
          </Reveal>
          ...
          <Reveal>
            <TextWithTitle
              title={
                'Учет прохождения субъектами финансового мониторинга обучения и тестирования'
              }
            />
          ...
          <Reveal>
            <HeaderWithLine headerColor={'#1F3C88'} lineColor={'#CADEFC'}>
              <>
                В целях подтверждения изучения субъектами материала, изученного
                в процессе обучения субъекты проходят{' '}
                <span class="bold">тестирование</span> с периодичностью не реже{' '}
                <span class="bold">1 (одного) раза в 3 (три) года</span> с даты
                прохождения тестирования на базе Национального центра по
                управлению персоналом государственной службы и его
          ...
          <Reveal>
            ...
            <Report_Information>
              <>
                <p className="italic">
                  Срок действия результатов тестирования составляет 3 (три) года
                  с момента прохождения аттестации с положительным результатом.{' '}
                </p>
              </>
            </Report_Information>
            <Sizebox height={40} />
          ...
          <Reveal>
            <TextWithTitle
              title={
                'В настоящее время процедура прохождения тестирования проходит следующим образом:'
              }
            />
          ...
          <Reveal>
            ...
            <TextWithTitle
              title={
                'При этом в Заявке тестируемый указывает свой ИИН и БИН организации (при наличии) и выбирает зал тестирования Центра, который имеется во всех регионах Казахстана, дату, а также время прохождения тестирования.\n'
              }
              text={[
        ...
        >
          ...
          <Reveal>
            ...
            <Centered>
              <JustTextWithP
                textData={[
                  'В соответствии с нормами действующего законодательства о ПОД/ФТ субъекты принимают соответствующие меры во избежание использования, как самих субъектов, так и его услуг иными лицами для совершения или оказания какого-либо содействия в легализации ОД/ФТ/ФРОМУ.',
                  'Таким образом, субъекты в целях противодействия ПОД/ФТ разрабатывают ПВК и программы их осуществления, а также несут ответственность за соблюдение правил и реализацию этих программ.',
                  'ПВК разрабатываются, принимаются органом управления или исполнительным органом СФМ с образованием юрлица и СФМ без образования юрлица и исполняются СФМ с учетом результатов оценки степени подверженности услуг СФМ рискам ОД/ФТ, размера, характера и сложности организации и, помимо требований к деятельности СФМ при проведении внутреннего контроля.',
                ]}
              ></JustTextWithP>
            </Centered>
            <Sizebox height={60}></Sizebox>
          ...
          <Sizebox height={70} />
            <TextWithTitle
              ...
              text={[
                'Данная Программа включает в себя, но не ограничивается:',
          ...
          <Reveal>
            <TextWithTitle
              title={'Вместе с тем услуги (продукты) Субъектов также могут быть подвержены к рискам.\n\nК примеру, нижеперечисленные факторы являются повышающими риск легализации ОД/ФТ/ФРОМУ, но не ограничиваются:'}
              text={[
                '1. операции с деньгами и (или) иным имуществом, превышающие пороговое значение;',
                '2. деловые отношения с клиентом осуществляются при необычных обстоятельствах (например, слишком большое необъяснимое географическое расстояние между Субъектом и клиентом);',
                ...
                '6. совершение клиентом операций с несвойственной ему частотой или на необычно крупную для данного клиента сумму и т.д.'
              ]}
            ></TextWithTitle>
          </Reveal>
          <Reveal>
          ...
          <Reveal>
            <TextWithTitle
              title={'При этом способы предоставления продукта (услуги), повышающими риск легализации ОД/ФТ/ФРОМУ, включают следующие факторы, но не ограничиваются:'}
              text={[
          ...
          <Reveal>
            ...
            <JustTextWithP
              textData={[
                'В рамках реализации данной Программы Субъектами принимаются меры по классификации клиентов с учетом категорий и факторов риска, а также иных категорий рисков, устанавливаемых Субъектами.',
                ...
                'Сама оценка рисков с использованием категорий и факторов рисков, проводится в отношении клиентов (групп клиентов) на основе результатов мониторинга операций (деловых отношений).'
              ]}
            >
          ...
          <Reveal>
            ...
            ></TextWithTitle>
            <TextWithTitle
              title={'Субъекты определяют и оценивают риски легализации ОД/ФТ/ФРОМУ, возникающие при:'}
              text={[
