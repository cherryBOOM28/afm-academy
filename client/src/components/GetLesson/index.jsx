          ...
          return (<LessonPage name={'О курсе'}>
              ...
              <Reveal>
                  <NumberedDots
                      ...
                      header={'Требования к СФМ по подготовке и обучению в сфере ПОД/ФТ:'}
                  />
              </Reveal>
              <Sizebox height={100}/>
        ...
        <LessonPage name={'Рекомендации ФАТФ'} lecturer={'AML Academy'}>
          <Reveal>
            ...
            <Reveal>
                <Sizebox height={80} />
                <VideoWithTitleAndText
                    url={'https://videos.sproutvideo.com/embed/4490d6b6191be9c5cd/3c475248b0e7c5fa'}
        ...
        >
          ...
          <Reveal>
            ...
            <Reveal>
                <Sizebox height={80} />
                <VideoWithTitleAndText
                    url={'https://videos.sproutvideo.com/embed/4d90d6b6191be9c8c4/83e0c5b82555df48'}
        ...
        >
          <Sizebox height={30} />
            <Reveal>
                <Sizebox height={80} />
                <VideoWithTitleAndText
                    url={'https://videos.sproutvideo.com/embed/0690d6b6191be9cf8f/0f0521a184a8ff1a'}
          ...
          <Reveal>
            <NotNumberedDots
              ...
              list={[
                ...
                '"правовые отношения субъектов финансового мониторинга", уполномоченного органа и других государственных органовРеспублики Казахстан в сфере ПОД/ФТ.'
              ]}
            />
          </Reveal>
          <Sizebox height={40} />
        ...
        >
          ...
          <TableWithData
              data={[
                {
                  option:
                 'В случае если хотя бы одна из сторон операций является лицом, включенным в Перечень ФРОМУ, и операции осуществляются в рамках договоров, заключенных "до включения таких лиц" в Перечень ФРОМУ, СФМ незамедлительно сообщают в АФМ о таких операциях (за исключением операций по зачислению денег).\n\n"АФМ" получив сообщение, относительно ситуации указанной выше, в течение двадцати четырех часов с момента его получения "приостанавливает" проведение операции на срок до "пятнадцати рабочих дней".\n\n"СФМ" до вынесения уполномоченным органом решения о приостановлении проведения операции "не проводит операцию" с деньгами и (или) иным имуществом, сообщение о которой предоставлено в соответствии с частью первой настоящего пункта.\n\nРешение о приостановлении проведения операции доводится до СФМ, представившего сообщение об операции, электронным способом или на бумажном носителе.\n\nПри этом, в случае неполучения СФМ "в течение двадцати четырех часов" с момента сообщения информации решения АФМ о приостановлении проведения операции операция должна быть проведена, если не имеются иные основания, предусмотренные законами Республики Казахстан, препятствующие проведению такой операции.'
                },
                {
                  option:
                   'АФМ после принятия решения о приостановлении проведения операции (не связанной с ФРОМУ) "в течение трех рабочих дней" принимает решение о проведении операции либо отказе в проведении операции и доводит его до СФМ.\n\nПосле истечения срока приостановления проведения операции по решению АФМ операция должна быть проведена при отсутствии иных оснований, предусмотренных законами Республики Казахстан, препятствующих проведению такой операции.'
                },
              ]}
              dataBtn={[
      ...
      return (
        ...
        >
          ...
          <Reveal><Sizebox height={40} />
            <TextWithTitle
              fontWeight={ 400 } title={'В целях реализации требований Закона о ПОД/ФТ по надлежащей проверке клиента (его представителя) и БС, а также по выявлению и направлению в АФМ сообщений об операциях, подлежащих финансовому мониторингу, Субъекты разрабатывают "программу мониторинга и изучения операций клиентов".'}
            ></TextWithTitle><Sizebox height={20} />
              <NumberedDots dotsColor={'#CADEFC'}
          ...
          <Reveal>
            ...
            <Sizebox height={20} />
            <TextWithTitle fontWeight={ 400 } title={'Полученные в рамках реализации Программы сведения вносятся в досье клиента и (или) хранятся у Субъекта на протяжении всего периода деловых отношений с клиентом и "не менее пяти лет после совершения" операции.'} />
            <Sizebox height={20} />
            <TextWithTitle fontWeight={400} title={'"Частота изучения" операций клиента "определяется Субъектами" с учетом уровня риска клиента и (или) степени подверженности услуг Субъектов, которыми пользуется клиент, рискам легализации ОД/ФТ/ФРОМУ, совершения (попытки совершения) клиентом операций (операции) с деньгами, а также с учетом типологий, схем и способов легализации ОД/ФТ/ФРОМУ.'} />
            <Sizebox height={20} />
            <TextWithTitle fontWeight={400} title={'"В случае присвоения клиенту высокого уровня риска", а также в случае совершения клиентом подозрительной операции Субъектами "изучаются операции", которые проводит (проводил) клиент за период до проведения операции, определяемый Субъектом, но не более одного месяца.'} />
          </Reveal><Sizebox height={40} />
          <Reveal>
          <Centered>
            <ImageLine
          ...
          <Reveal>
            <TextWithTitle title={'"Программа подготовки и обучения Субъектов" в сфере ПОД/ФТ/ФРОМУ разрабатывается в соответствии с Требованиями , утверждаемыми АФМ по согласованию с госорганами-регуляторами, в соответствии с пунктом 8 статьи 11 Закона о ПОД/ФТ.'} fontWeight={400} />
          <Sizebox height={20} />
